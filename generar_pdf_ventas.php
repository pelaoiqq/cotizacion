...
if (isset($_GET['id_cotizacion'])) {
    ...
    // Consultar los servicios asociados a la cotización
    ...
    $stmt_servicios->bind_param("i", $id_cotizacion);  // Vincular el parámetro de la cotización
    ...
    $pdf->Cell(5, 5, ':', 0, 0);
    $pdf->Cell(25, 5, utf8_decode($row['nombre_cliente']), 0, 0); // Mantener en la misma línea
    ...
    $pdf->Cell(5, 5, ':', 0, 0);
    $pdf->Cell(25, 5, utf8_decode($row['rut_cliente']), 0, 0); // Mantener en la misma línea
    ...
    $pdf->Cell(30, 5, utf8_decode($row['telefono_contacto']), 0, 1);
        ...
        $pdf->Cell(25, 5, utf8_decode($row['direccion_cliente']), 0, 1);
         ...
         $pdf->Cell(5, 5, ':', 0, 0);
         $pdf->Cell(25, 5, utf8_decode($row['nombre_contacto']), 0, 0); // Mantener en la misma línea
    ...
    $pdf->MultiCell(0, 8, utf8_decode("Estimados:\nDe acuerdo con lo solicitado, se envía cotización por el servicio de Ventas:"), 0, 'L');
    ...
    $pdf->Cell(0, 8, utf8_decode('SERVICIO DE VENTAS'), 0, 1, 'C', true);
...
/*
        ...
        $pdf->Ln(5);
         ...
         $pdf->Image('img/fima_fran.png', 80, 222, 60); // X = 10mm, Y = 50mm, ancho = 50mm

...
<div class="container my-5">
    <h2 class="text-center mb-4">Listado de Pagos Externos</h2>

    <form method="GET" action="listado_externos.php" class="mb-4">
        <div class="row g-3">
            <div class="col-md-3">
            ...
            <div class="col-md-3">
                ...
                <a href="listado_externos.php" class="btn btn-secondary">Limpiar</a>
            </div>
        </div>
    </form>

    <form method="GET" action="exportar_externo.php">
        ...
        <table class="table table-bordered table-striped mt-3">
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <?php $total_externo += $row['total_externo']; ?>
                    <tr>
                        <td><?php echo $row['id_cotizacion']; ?></td>
                        <td><?php echo date("d-m-Y", strtotime($row['fecha_inicio'])); ?></td>
                        <td class="text-end">$<?php echo number_format($row['total_externo'], 0, ',', '.'); ?></td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
            <tfoot>
                <tr class="table-secondary">
                    ...
                    <th class="text-end">$<?php echo number_format($total_externo, 0, ',', '.'); ?></th>
                </tr>
            </tfoot>
        </table>
